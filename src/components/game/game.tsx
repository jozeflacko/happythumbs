...
export default class Game extends React.Component {
    ...
    readonly MAX_RANDOM_NUMBER = 1000;
    readonly INIT_COUNTDOWN = 20;
    readonly ON_GAME_RESET_COUNTDOWN = 20;
    readonly INIT_SCORE = 0;
    readonly YOUR_SCORE = "Your score is: ";
    ...
    processScore() {
        switch (this.score) {
            case 5:
                ...
                break;
            case 10:
                this.addMessage("Can you do 100?");
                break;
            default:
                break;
        }
    ...
    clickEvent = (() => {
        ...
        const handleEvent = (event: any) => {
            ...
            if (event.target.id === MAIN_THUMB_ID) {
                ...
                if (mainThumb.getAttribute('disabled') !== 'true') {
                    ...
                    setTimeout(() => mainThumb.setAttribute('disabled', 'false'), 500);
                    this.insertThumb();
                    this.removeMessage();
                    this.timer.reset();
                }
        ...
        return {
            install: () => this.gameNode.addEventListener(CLICK, handleEvent),
            remove: () => this.gameNode.removeEventListener(CLICK, handleEvent)
        }
    })();
